...
//		playerControl = player.GetComponent<PlayerControl> ();
		...
		//This condition is just to make sure the target exists
		if (player == null){
...
//		}
		...
		targetPivotOffset = pivotOffset;   //NOT ON ORIGINAL CODE
		targetCamOffset = camOffset;   //NOT ON ORIGINAL CODE
		targetFOV = defaultFOV; //NOT ON ORIGINAL CODE
